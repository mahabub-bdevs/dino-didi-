...
class HomeScreensItemCardCustom extends StatelessWidget {
  const HomeScreensItemCardCustom({super.key});
              ...
              sliver: SliverGrid(
                delegate: SliverChildBuilderDelegate((context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      if (index == 2) {
                        Get.toNamed(AppRoutes.homeVersionTwoScreens);
                      }
                    },
                    child: Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(cardItem['boxImagePath']),
                          fit: BoxFit.fill,
                        ),
                      ),
                      child: Column(
